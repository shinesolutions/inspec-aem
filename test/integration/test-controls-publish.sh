...
PUBLISH_CONTROLS="publish-aem-6.2-standalone-quickstart-exist publish-aem-6.3-standalone-quickstart-exist publish-aem-6.4-standalone-quickstart-exist publish-aem-6.5-standalone-quickstart-exist publish-aem-6.2-standalone-quickstart-dont-exist publish-aem-6.3-standalone-quickstart-dont-exist publish-aem-6.4-standalone-quickstart-dont-exist publish-aem-6.5-standalone-quickstart-dont-exist aem-publish-succesfully-upgraded"
...
echo "Testing generic AEM Publish specific controls..."
for CONTROL in ${PUBLISH_CONTROLS}
do
  echo "Testing control: $CONTROL..."
  bundle exec inspec exec . "--controls=$CONTROL" || echo "Allowing test failure..."
done